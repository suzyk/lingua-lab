const Contact = () => {
  return (
    <div className="flex flex-col items-center justify-center px-6 py-6 flex-1 bg-white">
      {/* Header */}
      ...
      {/* Contact Card */}
      <div className="flex flex-col sm:flex-row items-center bg-white border-2 border-gray-200 rounded-3xl shadow-lg p-8 md:p-12 gap-8 w-full max-w-3xl">
